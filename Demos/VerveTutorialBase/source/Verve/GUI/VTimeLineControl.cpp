...
void VTimeLineControl::onRender( Point2I offset, const RectI &updateRect )
{
    ...
    if ( mSelection.Active )
    {
        ...
        // Render Time Cue.
        GFX->getDrawUtil()->drawRectFill( RectI( selectionPosition, selectionExtent ), ColorF( 0.f, 0.f, 0.f, 0.5f ) );
    ...
    if ( mController && !mSelection.Active )
    {
        ...
        // Render Time Cue.
        GFX->getDrawUtil()->drawRectFill( RectI( timeCuePosition, timeCueExtent ), ColorF( 0.f, 0.f, 0.f, 0.5f ) );
...
ConsoleMethod( VTimeLineControl, toPoint, S32, 3, 3, "( pTime )" )
{
...
ConsoleMethod( VTimeLineControl, toTime, S32, 3, 3, "( pPoint )" )
{
...
ConsoleMethod( VTimeLineControl, getSelection, const char *, 2, 2, "( )" )
{
...
ConsoleMethod( VTimeLineControl, setSelection, void, 3, 5, "( pActive, [pTime, pDuration] )" )
{
...
ConsoleMethod( VTimeLineControl, updateDuration, void, 2, 2, "( )" )
{
